...
func (c *Container) ID() string { _ = "STUB: not implemented"; return "" }

// Name returns the container name.
func (c *Container) Name() string { _ = "STUB: not implemented"; return "" }
...
func (c *Container) ImageName() string { _ = "STUB: not implemented"; return "" }

// Links returns a list containing the names of all the containers to which
// this container is linked.
func (c *Container) Links() []string { _ = "STUB: not implemented"; return nil }
...
func (c *Container) IsPumba() bool { _ = "STUB: not implemented"; return false }
...
func (c *Container) IsPumbaSkip() bool { _ = "STUB: not implemented"; return false }

// StopSignal returns the custom stop signal (if any) that is encoded in the
// container's metadata. If the container has not specified a custom stop
// signal, the empty string "" is returned.
func (c *Container) StopSignal() string { _ = "STUB: not implemented"; return "" }
